...
const testingPairs = [
  [
    ...
    ['action', { last: 'true', add: 'before' }, [['message', null, {
      key: { remoteJid: '917529871117@s.whatsapp.net', fromMe: true, id: '3EB009675E7ED37AABF2' }, message: { conversation: '*piano room timings are:*\n 6:00AM-12:00AM' }, messageTimestamp: '1584004403', status: 'DELIVERY_ACK',
    }], ['message', null, { key: { remoteJid: '917529871117@s.whatsapp.net', fromMe: false, id: '0FCEC5330F64929C6E9A2CFFD2BC8EAD' }, messageTimestamp: '1584004413', messageStubType: 'REVOKE' }], ['message', null, {
      key: { remoteJid: '917529871117@s.whatsapp.net', fromMe: true, id: '3EB003C7B539AFD09753' }, message: { conversation: "Sorry fren, I couldn't understand 'Libra'. Type 'help' to know what all I can do" }, messageTimestamp: '1584004417', status: 'DELIVERY_ACK',
    }], ['message', null, { key: { remoteJid: '917529871117@s.whatsapp.net', fromMe: false, id: 'A1230B8D6B0A1D793EC2AE2EA0C168D8' }, message: { conversation: 'library' }, messageTimestamp: '1584004418' }]]],
  ],
];
function testCoding() {
