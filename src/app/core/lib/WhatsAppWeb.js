...
class WhatsAppWeb {
	...
	constructor() {
	  ...
	  this.msgCount = 0; // number of messages sent to the server
	  this.autoReconnect = true; // reconnect automatically after an unexpected disconnect
	  // updated by sending a keep alive request to the server,
	  // and the server responds with our updated last seen
	  this.lastSeen = null;
	...
	// these can then be saved used to login again
